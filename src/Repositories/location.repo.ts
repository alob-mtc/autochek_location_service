...
export interface ILocationRepository {
   ...
   editLocation(id: string, data: LocationUpdateDTO): Promise<BaseResponse<{ updated: boolean }>>;
   ...
   deleteLocation(id: string): Promise<BaseResponse<Partial<{ deleted: boolean }>>>;

   calculateLocationDistanceFromCenterLocation(id: string): Promise<BaseResponse<Partial<{ message: string; distance: number; unit: string }>>>;
}
